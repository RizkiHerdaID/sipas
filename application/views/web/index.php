        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="glyphicon glyphicon-lock"></span> &nbsp Login
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" action="<?php echo site_url('web/proses');?>" method="post">
                                    ...
                                    <div class="form-group last">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <button type ="submit" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-log-in"></span> Login</button>
                                            <button type ="reset" class="btn btn-primary btn-default"><span class="glyphicon glyphicon-refresh"></span> Refresh</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <span class="glyphicon glyphicon-stats"></span> &nbsp Peringkat 5 Besar Peminjam Teraktif
                                    </div>
                                    <div class="panel-body">
                                ...
                                <?php if(count($peringkat) == 0){ echo "Tidak ditemukan data"; }?>
                                    </div>
                        </div>
                    ...
                    <div class="col-md-8 ">
                        <legend>Selamat Datang di Aplikasi Perpustakaan Masjid Al-Hikmah Universitas Jember</legend>
