...
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="text" name="nim" class="form-control" value="<?php echo $anggota['nim'];?>" readonly="readonly">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
            ...
            <select name="prodi" class="form-control">
                <option value="">--Pilih Salah Satu--</option>
                    <?php foreach ($listprodi as $prod) { 
                        if ($anggota['prodi']==$prod->prodi) {?>
                            <option value = "<?php echo $prod->prodi ?>" selected><?php echo $prod->prodi ?></option>
                        <?php } else { ?>
     ...
     <div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="text" name="hp" class="form-control" value="<?php echo $anggota['hp'];?>">
        </div>
    </div>
    <div class="form-group">
