<script>
    $(function(){
        ...
        $("#caritrans").keyup(function(){
            var no=$("#caritrans").val();
            
            $.ajax({
                url:"<?php echo site_url('pengembalian/cari_by_trans');?>",
                type:"POST",
                data:"no="+no,
                cache:false,
                success:function(html){
                    $("#tampiltrans").html(html);
                }
            })
        })
...
<div class="panel panel-warning">
        ...
        <form class="form-horizontal" action="" method="post">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <a href="#" class="btn btn-warning" id="cari"><i class="glyphicon glyphicon-search"></i></a>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" name="nim" id="nim" class="form-control" readonly="readonly">
                    </div>
                </div>
    ...
    <div class="panel-footer">
        <button id="simpan" class="btn btn-warning"><i class="glyphicon glyphicon-saved"></i> Simpan</button>
    </div>
</div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-5">Cari No. Transaksi</label>
                                <div class="col-lg-5">
                                    <input type="text" id="caritrans" class="form-control">
                                </div>
                            </div>
                        </div>
                        
                        <div id="tampiltrans"></div>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->