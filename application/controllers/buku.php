...
class Buku extends CI_Controller{
    ...
    function tambah(){
        ...
        if($this->form_validation->run()==true){//jika validasi dijalankan dan benar
            ...
            if($cek->num_rows()>0){ // jika kode sudah ada, maka tampilkan pesan
                $data['message']="<div class='alert alert-danger'><b>Gagal!</b> Kode Buku sudah ada</div>";
		...
		$config['max_height']  = '1024';
            ...
            $data['message']="";
            $data['klasifikasi'] = $this->m_buku->klasifikasi();
            $this->template->display('buku/tambah',$data);
        }
    }
    ...
    function cari(){
        ...
        if($cek->num_rows()>0){
            ...
            $data['message']="<div class='alert alert-warning'><b>Maaf!</b> Data tidak ditemukan</div>";
            $data['buku']=$cek->result();
            $this->template->display('buku/cari',$data);
        }
    }
